var isOldColorInitialized=false;var currentColorHSL=[0,50,50];var currentColorRGB=[0,0,0];var isMyself=false;var __t=true;
...
}else{if(a.data.menuId=="aboutMenuItem"){alert("MyColorPicker version 1.5.0.trial - Thanks for using")}}}}function addSwatch(){if(isInPhotoshop){var a="_ext_addSwatch("+currentColorRGB[0]+","+currentColorRGB[1]+","+currentColorRGB[2]+")";
